...
- `get_transaction` - gets transaction data for a single transaction
...
- `bulk_update_transactions` - modifies one or more attributes for multiple existing transactions
